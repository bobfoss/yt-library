...
CREATE INDEX IF NOT EXISTS idx_playlist_video_reconciled_channel ON playlist_video_reconciled(channel_id);
CREATE INDEX IF NOT EXISTS idx_archivarix_candidates_playlist ON archivarix_candidates(playlist_id, title);
CREATE INDEX IF NOT EXISTS idx_archivarix_candidates_channel ON archivarix_candidates(channel_id);
...
CREATE INDEX IF NOT EXISTS idx_snapshot_video_recovery_channel ON snapshot_video_recovery(channel_id);
...
CREATE INDEX IF NOT EXISTS idx_playlist_videos_channel ON playlist_videos(channel_id);
...
CREATE INDEX IF NOT EXISTS idx_youtube_history_occurrences_channel ON youtube_history_occurrences(channel_id);
...
CREATE INDEX IF NOT EXISTS idx_takeout_history_occurrences_channel ON takeout_history_occurrences(channel_id);
CREATE INDEX IF NOT EXISTS idx_history_reconciled_video ON history_reconciled(video_id);
CREATE INDEX IF NOT EXISTS idx_history_reconciled_channel ON history_reconciled(channel_id);
